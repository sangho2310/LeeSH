...
public class Function1 {
	...
	//main 함수에 코딩을 하면 ===> 프로그램 실행시 main함수 실행 
	public static void main(String[] args) {
		// 자바에는 막혀있지만 '함수'라는 개념이 있음 
		// 함수 : 코드를 저장해놓는 공간
		// 변수 : 값을 저장하는 공간 
		System.out.println();		//출력을 해주는 함수 (출력하는 코드가 저장되어있음)
		
		//자바에서는 함수를 직접저으로 사용하지 않고
...
/*
	...
	왜냐하면 자바의 출시 목적이 모든 프로그래밍 언어를 통합하기 위해서 
