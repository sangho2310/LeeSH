...
public class Method2 {
	public static void main(String[] args) {
		...
		String result3 = mc5.메서드3();		//메서드3을 사용
		result3 = mc5.메서드3();				//메서드3을 사용
...
class MyClass5{
	...
	void 메서드1() {
		//입력값이 없으면 ()를 비워놓는다
		//반환값이 없으면 자료형은 void로 하고 return을 생략
	...
	//메서드2 : 반환값 X 입력값O (코드 재활용, 일부 변수만 바뀌는 경우)
	void 메서드2(String str1, String str2) {
		//입력값이 있으면 입력받고자 하는 값의 변수들을 미리 생성해놓는다
	...
	//메서드3 : 반환값 o 입력값x (코드 재사용, 메서드 사용 후에 마지막으로 전달해줄 값이 있음)
	String 메서드3() {
	...
	int 메서드4(double dnum) {
		//입력값이 있으면()를 변수로 채워놓고
		//반환값이 있으면 return을 사용하고 맨앞의 자료형을 맞춰준다.
